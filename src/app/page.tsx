...
export default function Home() {
  return (
    <main
      className={`flex min-h-screen flex-col items-center justify-center p-24 ${styles.background}`}
    >
      <Image
        className="relative mb-8 md:mb-12 lg:mb-16 xl:mb-20 w-[140px] h-[39px] md:w-[240px] md:h-[60px] xl:w-[281px] xl:h-[78px]"
        ...
        priority
      />
      <h3 className="text-2xl md:3xl xl:text-5xl font-montserrat text-secondary mb-2 xl:mb-4">
        Coming soon
      </h3>
      <h1 className="text-3xl md:text-5xl xl:text-8xl font-champBlack max-w-[600px] xl:max-w-[900px] text-center mb-8 md:mb-12 lg:mb-16 xl:mb-20">
