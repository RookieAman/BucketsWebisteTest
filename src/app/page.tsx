  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="transition-all duration-200 bg-secondary hover:bg-darkchoco hover:text-secondary border-2 border-secondary border-solid text-darkchoco rounded-full px-10 md:px-14 xl:px-20 py-2 xl:py-5 uppercase text-2xl md:text-3xl xl:text-4xl font-montserrat font-extrabold mb-2 xl:mb-5"
      >
        Contact
      </a>
      {/* <a
